...
class ConsumerIdentityName(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ConsumerIdentityNameResp']:
            return ConsumerIdentityNameResp

    def __new__(
        cls,
        arg: typing.Union[typing.Tuple['ConsumerIdentityNameResp'], typing.List['ConsumerIdentityNameResp']],
    ...
    def __getitem__(self, i: int) -> 'ConsumerIdentityNameResp':
