...
class RiskModelResp(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["evaluation", "modelIndicator", "score", "scoreFactors", "scorePercentile", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["evaluation", "modelIndicator", "score", "scoreFactors", "scorePercentile", ], str]):
