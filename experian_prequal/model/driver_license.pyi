...
class DriverLicense(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["number", "state", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["number", "state", ], str]):
