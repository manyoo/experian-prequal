...
# body param
SchemaForRequestBodyApplicationJson = PrequalScoreRequest
...
SchemaFor200ResponseBodyApplicationJson = PrequalScoreResponse
...
class CreditScore(BaseApi):
    ...
    def credit_score(
        ...
        return self._credit_score_oapg(
            body=body,
